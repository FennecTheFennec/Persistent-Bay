...
/obj/item/clothing/suit/armor/bulletproof/light/tcclight
	...
	desc = "A vest of armor with a light kevlar plate to protect against ballistic projectiles. Looks like it might impair movement."
	icon = ITEM_INHAND
	icon_override = TCC_OVERRIDE
...
/obj/item/clothing/suit/armor/bulletproof/medium/tccmedium
	...
	desc = "A vest of armor with a moderately thicker and heavier kevlar plate than it's light counterpart to protect against ballistic projectiles. Looks like it might impair movement."
	icon = ITEM_INHAND
	icon_override = TCC_OVERRIDE
...
/obj/item/clothing/suit/armor/bulletproof/heavy/tccheavy
	...
	desc = "A vest of armor with a stronger and heavier kevlar plate than it's lighter and weaker counterparts to protect against ballistic projectiles. Looks like it might impair movement."
	icon = ITEM_INHAND
	icon_override = TCC_OVERRIDE
